...
from config import (
    MLFLOW_HOST,
    MLFLOW_TRACKING_URI,
    PROJECT_TASK_TYPES as CONFIG_PROJECT_TASK_TYPES,
...
# =============================================================================
# MLflow Configuration (use imported values from config.py)
# =============================================================================
mlflow.set_tracking_uri(MLFLOW_TRACKING_URI)

# Model name mapping for MLflow (alias for imported config)
MLFLOW_MODEL_NAMES = BATCH_MODEL_NAMES.copy()
...
# =============================================================================
# Best Metric Criteria (sklearn uses different metric names than River)
# Format: {"metric_name": str, "maximize": bool}
# =============================================================================
BEST_METRIC_CRITERIA = {
    # sklearn metric names (differ from River: fbeta_score vs FBeta, silhouette_score vs Silhouette)
...
# =============================================================================
# Delta Lake Paths (using s3:// for DuckDB delta_scan)
# NOTE: These paths use s3:// protocol for DuckDB compatibility.
# The config.py paths use s3a:// for Spark/Hadoop compatibility.
# =============================================================================
DELTA_PATHS = {
...
# =============================================================================
# Task Type Configuration (use imported values from config.py)
# =============================================================================
PROJECT_TASK_TYPES = CONFIG_PROJECT_TASK_TYPES.copy()

# PROJECT_TARGET_COLUMNS is imported from config.py
